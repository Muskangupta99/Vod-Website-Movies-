...
* For Google Sign in to work, the individual credentials have to be generated by Google for the use of their API.For uploading purposes those fields are empty in config2.php
#### DATABASE SCHEMA
