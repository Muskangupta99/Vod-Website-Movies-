...
.genre{
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <ul class="nav navbar-nav navbar-right ">
      <li class="nav-item">
        <a class="nav-link" href="login3.php" >Login <span class="sr-only">(current)</span></a>
      </li>
	   <li class="nav-item">
        <a class="nav-link"  href="#" data-toggle="modal" data-target="#modalRegisterForm">Sign up <span class="sr-only">(current)</span></a>
      </li>
	  <li class="nav-item">
...
<div class="jumbotron">
  <h1 class="display-3">Login to Stream Online and get Updates!</h1>
  <p class="lead">or download them on your device</p>
  <hr class="my-2">
